<?php
/**
 * Benmarokna functions and definitions
 *
...
if ( ! function_exists( 'benmarokna_setup' ) ) :
	/**
	 ...
	 */
	function benmarokna_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Benmarokna, use a find and replace
		 * to change 'benmarokna' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'benmarokna', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'benmarokna' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'benmarokna_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'benmarokna_setup' );
 ...
 */
function benmarokna_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'benmarokna_content_width', 640 );
}
add_action( 'after_setup_theme', 'benmarokna_content_width', 0 );
 ...
 */
function benmarokna_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'benmarokna' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'benmarokna' ),
...
add_action( 'widgets_init', 'benmarokna_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'benmarokna_scripts' );
