...
<main class="page">
    ...
    <section class="hero__offer hero__offer--page hero__offer--page--portfolio">
        <section class="hero__offer__item" data-aos="zoom-in">
            ...
            <a class="hero__offer__item__button button--hover" href="/">
                Zobacz realizacje
            </a>
        </section>
        <section class="hero__offer__item" data-aos="zoom-in">
    ...
    <section class="section section--marginSmall">
        <h1 class="section__header section__header--small" data-aos="flip-up">
            Dowiedz się więcej
        </h1>
        <p class="section--marginSmall__text" data-aos="fade-up">
        ...
        <section class="flex marginTop flex--portfolio">
            <a class="button--red button--margin" data-aos="flip-up" href="<?php echo get_page_link(get_page_by_title('Oferta')->ID); ?>">
                Sprawdź naszą ofertę
            </a>
            <a class="button--red button--margin button--hover" data-aos="flip-up" href="<?php echo home_url() . '#kontakt'; ?>">
                Skontaktuj się z nami
            </a>
            <a class="button--red button--margin button--hover" data-aos="flip-up" href="<?php echo get_page_link(get_page_by_title('O nas')->ID); ?>">
