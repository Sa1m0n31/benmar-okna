    ...
    <section class="section section--numbers">
        ...
        <main class="section--numbers__main">
            <section class="section--numbers__item section--numbers__item--aboutUs" data-aos="zoom-in">
                ...
                <p class="section--numbers__text">
                    Wybierz preferowany kontakt z nami! Zadzwoń, napisz e-mail, użyj formularza kontaktowego lub odwiedź nas osobiście.
                </p>
            </section>
            ...
            <section class="section--numbers__item section--numbers__item--aboutUs" data-aos="zoom-in">
                ...
                <p class="section--numbers__text">
                    Będziemy Ci doradzać na każdym etapie współpracy. Począwszy od wyboru produktu, aż po sam koniec realizacji.
                </p>
            </section>
        </main>
    </section>
        ...
        <section class="section--flex">
            <section class="section--flex__section" data-aos="fade-right">
                ...
                <ul class="section__redList">
                    <li>
                        Atrakcyjne rabaty cenowe
                    </li>
                    <li>
                        Doradztwo na każdym kroku inwestycji
                    </li>
                    <li>
                    ...
                    <li>
                        Wieloletnią gwarancję na produkty i usługi
                    </li>
                </ul>
            </section>
        ...
        <section class="section--flex section--flex--aboutTeam">
            <article class="section--flex__section section--flex__section--article" data-aos="fade-right">
                <section class="section__aboutTeam__item">
                    ...
                    <p class="section__aboutTeam__item__text">
                        Zaangażowanie naszych pracowników wynika z kilku powodów. Najważniejszym jest fakt, że są dobrze opłacani i przyzwyczajeni do premii za należytą pracę. Dodatkowo więdzą, że lepiej nie denerwować szefostwa.
                    </p>
                </section>
                <section class="section__aboutTeam__item">
                    <h3 class="section__aboutTeam__item__header">
                    ...
                    <p class="section__aboutTeam__item__text">
                        Każdy kierownik zlecenia posiada wykształcenie techniczne. Kładziemy na to nacisk, by sprawnie obsługiwali dokumentację techniczną i mogli doradzać spersonalizowane rozwiązania naszym klientom.
                    </p>
                </section>
                <section class="section__aboutTeam__item">
                    <h3 class="section__aboutTeam__item__header">
                    ...
                    <p class="section__aboutTeam__item__text">
                        Każdy z naszych pracowników posiada wieloletnie doświadczenie w branży. A sama firma wiedzie prym na rynku lokalnym, w ramach realizacji zleceń związanych z oknami, drzwiami, tarasami czy ogrodzeniami.
                    </p>
                </section>
            </article>
            <figure class="section--flex__section" data-aos="fade-left">
